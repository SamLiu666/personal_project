...
class CNN_languageModel(Seq2Seq):
    def __init__(self, enc_v_dim, dec_v_dim, emb_dim, units, max_pred_len, start_token, end_token):
        super(CNN_languageModel, self).__init__(enc_v_dim, dec_v_dim, emb_dim, units, max_pred_len, start_token, end_token)
